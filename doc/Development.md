# Development and Testing Guide <br/> Pip.Services Couchbase Components for Node.js
...
- Download and install Couchbase database from https://www.couchbase.org/downloads
