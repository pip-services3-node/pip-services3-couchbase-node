 ...
 *     });
 */
export declare class CouchbasePersistence implements IReferenceable, IConfigurable, IOpenable, ICleanable {
     ...
     */
    protected _connectionResolver: CouchbaseConnectionResolver;
    /**
